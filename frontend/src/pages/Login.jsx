      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="px-8 py-6 text-left bg-white shadow-lg rounded-xl w-full max-w-md animate-slide-in-right hover:shadow-xl transition-shadow duration-300">
          <div className="lg:hidden text-center mb-6 animate-bounce-in">
            <h1 className="text-3xl font-bold text-blue-700">Dr.Tumor</h1>
            <p className="text-slate-500 text-sm">AI-Powered Medical Diagnosis</p>
          </div>
          <h3 className="text-2xl font-bold text-center text-gray-900 animate-fade-in">Welcome Back</h3>
          <p className="text-center text-gray-600 text-sm mb-4 animate-fade-in" style={{animationDelay: '0.1s'}}>Sign in to your account</p>
          ...
          <div className="mt-4">
            ...
            <div className="flex items-baseline justify-between">
              <button className="px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 active:scale-95">Login</button>
              <Link to="/register" className="text-sm text-blue-600 hover:text-blue-700 hover:underline transition-colors duration-200">Register</Link>
            </div>
          </div>
        </form>
        </div>
