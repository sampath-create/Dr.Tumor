...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-800 to-blue-900 flex-col justify-center items-center p-12">
        <div className="text-center animate-fade-in">
          <h1 className="text-5xl font-bold text-white mb-2 animate-slide-up">Dr.Tumor</h1>
          <p className="text-blue-100 text-lg mb-8 animate-slide-up" style={{animationDelay: '0.1s'}}>AI-Powered Medical Diagnosis System</p>
          ...
          <div className="grid grid-cols-2 gap-6 mt-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center animate-scale-in hover:scale-105 transition-transform duration-300" style={{animationDelay: '0.2s'}}>
              <p className="text-4xl font-bold text-blue-100">{stats.patients}</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center animate-scale-in hover:scale-105 transition-transform duration-300" style={{animationDelay: '0.3s'}}>
              <p className="text-4xl font-bold text-blue-100">{stats.doctors}</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center animate-scale-in hover:scale-105 transition-transform duration-300" style={{animationDelay: '0.4s'}}>
              <p className="text-4xl font-bold text-blue-100">{stats.lab_reports_analyzed}</p>
              <p className="text-blue-200 text-sm">Lab Reports Analyzed</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center animate-scale-in hover:scale-105 transition-transform duration-300" style={{animationDelay: '0.5s'}}>
              <p className="text-4xl font-bold text-blue-100">{stats.accuracy_rate}%</p>
              <p className="text-blue-200 text-sm">Accuracy Rate</p>
            </div>
          </div>
          
          <p className="text-blue-200 text-sm mt-8 max-w-md animate-fade-in" style={{animationDelay: '0.6s'}}>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="px-8 py-6 text-left bg-white shadow-lg rounded-xl w-full max-w-md animate-slide-in-right hover:shadow-xl transition-shadow duration-300">
          <div className="lg:hidden text-center mb-6 animate-bounce-in">
            <h1 className="text-3xl font-bold text-slate-700">Dr.Tumor</h1>
            <p className="text-slate-500 text-sm">AI-Powered Medical Diagnosis</p>
          </div>
          <h3 className="text-2xl font-bold text-center text-gray-900 animate-fade-in">Create Account</h3>
          <p className="text-center text-gray-600 text-sm mb-4 animate-fade-in" style={{animationDelay: '0.1s'}}>Join our healthcare platform</p>
          ...
          <div className="mt-4">
            <div>
              ...
              <input type="text" name="full_name" placeholder="Full Name"
                className="w-full px-4 py-2 mt-2 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 bg-slate-50"
            ...
            <div className="mt-4">
              ...
              <select name="role" className="w-full px-4 py-2 mt-2 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 bg-slate-50"
            ...
            <div className="mt-4">
              <label className="block text-slate-700">Gender</label>
              <select name="gender" className="w-full px-4 py-2 mt-2 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 bg-slate-50"
            ...
            {formData.role === 'patient' && (
              <div className="mt-4 p-4 bg-slate-100 rounded border border-slate-200 animate-fade-in">
                 <h4 className="text-sm font-bold text-slate-800 mb-2">Patient Details</h4>
                 <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label className="block text-xs text-slate-700">Height (cm)</label>
                        <input type="number" name="height" placeholder="Height"
                            className="w-full px-2 py-2 mt-1 border border-slate-200 rounded-md text-sm bg-white"
                            onChange={handleChange} />
                    </div>
                    <div>
                        <label className="block text-xs text-slate-700">Weight (kg)</label>
            ...
            {['doctor', 'lab_technician', 'pharmacy'].includes(formData.role) && (
              <div className="mt-4 p-4 bg-slate-100 rounded border border-slate-200 animate-fade-in">
                 <h4 className="text-sm font-bold text-slate-800 mb-2">Professional Verification</h4>
                 <div>
                    <label className="block text-xs text-slate-700">Upload Certificate/License (PDF/Image)</label>
            ...
            <div className="flex items-baseline justify-between">
              <button className="px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 active:scale-95">Register</button>
              <Link to="/login" className="text-sm text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200">Login</Link>
            </div>
          </div>
        </form>
        </div>
